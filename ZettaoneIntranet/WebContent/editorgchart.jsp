                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="">Modify Organization Chart</a></li> 
                            </ul>
                            <form action="policyPage" method="post"> 
								<div class="payment-adress"> 
                                     <button class="btn btn-primary waves-effect waves-light col-md-offset-9 col-md-3" type="submit" name="submit" value="orgListing">Back to Organization List</button>
      							</div>
							</form>
                                                ...
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="policyPage" method="post" enctype="multipart/form-data" class="dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                                            	<div class="form-group">
                                                                     <input type="hidden" id="policy_id" name="policy_id" value='${ab.policy_id}'>
                                                                </div>
                                                            	<div class="form-group"> 
                                                              		  <input name="title" type="text" class="form-control" placeholder="Title" value="${pb.title}" required>
                                                                </div> 
                                                                <input type="file" id="policy" value="${pb.policy}" name="policy"/>  <div id="imagePreview"></div>
                                                            </div>
                                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"></div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12"> 
                                                                <div class="payment-adress"> 
                                                                     <button class="btn btn-primary waves-effect waves-light" type="submit" name="submit" value="editsave">Upload</button>
