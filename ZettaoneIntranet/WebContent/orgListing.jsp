...
<title>Organization Chart | Zettaone Technology</title>
	...
	<div class="left-sidebar-pro">
		<nav id="sidebar" class="">
			<div class="sidebar-header">
				<a href="home.jsp"><img class="main-logo"
					src="img/logo/logo.png" alt="" /></a> <strong><a
					href="home.jsp"><img src="img/logo/logosn.png" alt="" /></a></strong>
			</div>
			<div class="left-custom-menu-adp-wrap comment-scrollbar">
				<nav class="sidebar-nav left-sidebar-menu-pro">
					<ul class="metismenu" id="menu1">
						...
						<li><a title="Zettaone website"
							href="http://www.zettaone.com/" target="_blank"
